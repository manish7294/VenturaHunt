...
$mobilenoError="Please enter a valid number";}
  ...
  $sel=mysql_query("select * from profile where username='$username' ");
  $arr=mysql_fetch_array($sel);
  if(($arr['email']==$email) and $arr['mobileno']==$mobileno and $arr['username']=$username){
  $res1 = mysql_query("update login set hash='$hash' where username='$username'");
  }
...
This email has been send to you in response of your password change request.</br></p>
<p style="font-family: \'Abel\', sans-serif;font-size:15px; background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
Please verify your request by pressing the button below.</br></br></p>
...
<a href="http://www.venturahunt.com/cpassword.php?username='.$username.'&hash='.$hash.'" style="margin-left:35%;  padding: 4px 10px;background: #6495ED; border: solid 1px #20538D; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.4);  text-decoration: none;color: #FFF; border-radius:4px;">Confirm Your Request</a></br></br>
</p>
<p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
Or, just open this link to change your password:</br></p>
<p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
http://www.venturahunt.com/cpassword.php?username='.$username.'&hash='.$hash.'
</p>
...
Contact us in case you have not requested for password change. </p>
</body></html>
