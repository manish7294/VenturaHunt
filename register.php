...
Thanks for signing up!</br></p>
<p style="font-family: \'Abel\', sans-serif;font-size:15px; background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
Your account has been created, please verify your account by pressing the button below.</br></br></p>
...
<a href="http://www.venturahunt.com/verify.php?username='.$username.'&hash='.$hash.'" style="margin-left:35%;  padding: 4px 10px;background: #6495ED; border: solid 1px #20538D; text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.4);  text-decoration: none;color: #FFF; border-radius:4px;">Confirm Your Account</a></br></br>
</p>
<p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
Or, just open this link to activate your account:</br></p>
<p style="font-family: \'Abel\', sans-serif;font-size:15px;  background-color:#98FB98; margin-left:2%;margin-right:2%; padding-left:1.6%;">
http://www.venturahunt.com/verify.php?username='.$username.'&hash='.$hash.'  </p>
...
Please ignore this email if you have already activated your account on VenturaHunt. </p>
</body></html>
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group ">
             ...
             <input type="text" name="name" class="form-control"  style="width:300px;" placeholder="Enter Your Name" maxlength="50" value="<?php echo $name ?>" />
                </div>
             ...
             <input type="text" name="username" class="form-control"  style="width:300px;" placeholder="Enter Your UserName" maxlength="50" value="<?php echo $username ?>" />
                </div>
            ...
            <div class="form-group">
             ...
             <input type="email" name="email" class="form-control"  style="width:300px;" placeholder="Enter Your Email" maxlength="40" value="<?php echo $email ?>" />
                </div>
             ...
             <div class="input-group">
              ...
              <input type="text" name="mobileno" class="form-control"  style="width:300px;" placeholder="Enter Your Mobile Number" maxlength="50" value="<?php echo $mobileno ?>" />
                </div>
            ...
            <div class="form-group">
             ...
             <input type="text" name="college" class="form-control"  style="width:300px;" placeholder="Enter Your College/School Name" maxlength="50" value="<?php echo $college ?>" />
                </div>
    ...
    <div class="container">
        <div class="row-fluid">
             <div class="span5 cp"style="font-family: 'Josefin Slab', serif;; font-size:15px;" >
                &copy; 2016 <a target="_blank" href="#" title="Techfest IIT(ISM) DHANBAD">Concetto</a>. All Rights Reserved. <h5>Site designed and maintained by <a data-toggle="modal" href="#manish">Manish Kumar</a></h5>
            </div>
            <!--/Copyright-->
